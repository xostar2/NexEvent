...
const url1 = "http://localhost:8000/api/v1/vendors/getdetailsuser";
  ...
  useEffect(() => {
   const fetchdetailspackage = async () => {
    try {
      ...
      const response = await axiosInstance.get(`http://localhost:8000/api/v1/packages/getallpackage/${eventId}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("ventoken")}`,
        },
      });
