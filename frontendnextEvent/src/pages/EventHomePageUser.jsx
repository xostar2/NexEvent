...
const url1 = "http://localhost:8000/api/v1/vendors/getvendordetailsuser";
...
//==========================================================================================================================================
  ...
  const fetchVendorDetails = async () => {
    ...
    try {
      const response = await axiosInstance.get(`http://localhost:8000/api/v1/vendors/getvendordetails/${ownerId}`, {//yhi galti he bhai
...
useEffect(() => {
    const fetchdetailspackage = async () => {
     try {
       ...
       const response = await axiosInstance.get(`http://localhost:8000/api/v1/packages/getallpackages/${eventId}`, {
         headers: {
